...
public class TESTING {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" VALOR TOTAL DA COMPRA  R$" + bruto);
        ...
        do {
            ...
            if (opcao == 1) {
                ...
                if (parcelas <= 1) {
                    ...
                    System.out.println("Valor pago em x" + parcelas + " || " + "R$ " + bruto);
        ...
        if (bruto >= 400 && parcelas <= 1) {
            porcentagem = bruto - (bruto * 0.1);
            bruto = (bruto * 10) / 100;

            System.out.println("PROMOÇÃO EFETUADA");
            System.out.println("Valor do desconto de 10% - R$" + bruto);
            System.out.println("Valor com desconto " + " R$" + porcentagem);
            System.out.println("Valor sem desconto R$" + preVenda);
        }
